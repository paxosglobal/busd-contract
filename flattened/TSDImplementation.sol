...
// File: contracts/TSDImplementation.sol
...
/**
 * @title TSDImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing TSDImplementation
...
contract TSDImplementation {
    ...
    string public constant name = "Test USD"; // solium-disable-line
    ...
    */
    ...
    /**
     * @dev Reclaim all TSD at the contract address.
     * This sends the TSD tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimTSD() external onlyOwner {
